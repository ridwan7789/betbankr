...
const marketsData: Record<string, {
  ...
  "3": {
    ...
    liquidity: "$2.1M",
    timeRemaining: "11mo",
    description: "This market resolves YES if blockchain's Total Value Locked (TVL) exceeds Ethereum's TVL at any point before January 1, 2027. Data will be sourced from DefiLlama.",
    volume24h: "$98.7K",
    traders: 1892,
    created: "Nov 20, 2025",
